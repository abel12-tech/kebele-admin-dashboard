...
const ManageRenewalRequests = () => {
  ...
  const idType = "Renewal";

  const filteredRequests = requests?.filter(
    (request) => request.idType === idType
  );
                      ...
                      >
                        <td className="px-4 py-3">
                          <div className="flex items-center text-sm">
                            ...
                            <div>
                              <p className="font-semibold">{request.idType}</p>
...
export default ManageRenewalRequests;
